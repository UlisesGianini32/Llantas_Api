...
<div class="mx-auto max-w-lg rounded-lg border border-neutral-800 bg-neutral-900 p-6">
    ...
    <form method="POST" action="{{ route('llantas.update', $llanta->id) }}">
        ...
        <div class="mb-4">
            ...
            <textarea name="descripcion" class="w-full rounded bg-neutral-800 p-2 text-white">{{ old('descripcion', $llanta->descripcion) }}</textarea>
        </div>
        ...
        <div class="mb-4">
            <label class="text-sm text-gray-400">Precio ML</label>
        ...
        <div class="flex justify-between">
            <a href="{{ route('llantas.index') }}" class="text-gray-400">Cancelar</a>
            <button class="rounded bg-indigo-600 px-4 py-2 text-white">Guardar</button>
        </div>
    </form>
